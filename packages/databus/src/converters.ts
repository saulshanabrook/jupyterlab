 ...
 */
export interface IConverter<A extends IDataset, B extends IDataset> {
  /**
...
export class ConverterRegistry {
   ...
   */
  convert<A extends IDataset, B extends IDataset>(
    sourceDataset: A,
    targetMimeType: string
  ): Promise<B> {
   ...
   */
  private _resolveConverter<A extends IDataset, B extends IDataset>(
    sourceMimeType: string,
    targetMimeType: string
  ): IConverter<A, B> {
    let converters: Set<IConverter<any, any>> = this._converters.get(
